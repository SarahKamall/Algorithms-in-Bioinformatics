...
def optionality():
    ...
    print("Do you want to make global alignment for \n1) DNA sequences  \n2) Protein sequences  \n3) Exit the system?")
    ...
    if choose == 1:
        ...
        if check_input(firstString,secondString,choose):
            Global(firstString,secondString,choose,gap,m,mm)
        else:
            optionality()
    elif choose == 2:
        ...
        gap = int(input("Enter the gap penalty: "))
        if check_input(firstString,secondString,choose):
            Global(firstString,secondString,choose,gap,None,None)
        else:
            optionality()
    elif choose == 3:
        sys.exit()
...
def Global(first_seq,second_seq,choose,gap,m,mm):
